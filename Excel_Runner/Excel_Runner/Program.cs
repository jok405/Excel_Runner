...
namespace Excel_Runner
{
    /// <summary>
    /// Fast Excel
    /// </summary>
    public partial class Excel_Runner : IDisposable
    {
        /// <summary>
        /// Output excel file
        /// </summary>
        ...
        public Excel_Runner(FileInfo excelFile, bool readOnly = false) : this(null, excelFile, true, readOnly) { }
        ...
        public Excel_Runner(FileInfo templateFile, FileInfo excelFile) : this(templateFile, excelFile, false, false) { }

        private Excel_Runner(FileInfo templateFile, FileInfo excelFile, bool updateExisting, bool readOnly = false)
        {
